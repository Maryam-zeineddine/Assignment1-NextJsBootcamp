    ...
    <main className='bg-gradient-to-br from-rose-50 via-slate-50 to-cyan-50 py-14'>
      <section className='mx-auto max-w-4xl space-y-8 px-4 sm:px-6'>
        <div className='rounded-[2rem] border border-slate-200 bg-white p-10 shadow-sm'>
          ...
          <p className='mt-3 max-w-2xl text-base leading-7 text-slate-600'>Browse the latest updates and insights from this developer in a calm, pastel experience.</p>
        </div>
